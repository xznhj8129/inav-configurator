...
var SerialBackend = (function () {
    ...
    publicScope.init = function() {
        ...
        GUI.handleReconnect = function ($tabElement) {
            ...
            let modal;
            const useDisconnectReconnect = BOARD.hasVcp(FC.CONFIG.boardIdentifier) || CONFIGURATOR.mavlinkTunnelActive;

            if (useDisconnectReconnect) { // VCP and tunnel-mode links need a full reconnect cycle
                ...
                */
                ...
                }, CONFIGURATOR.mavlinkTunnelActive ? 4000 : 7000);
            } else {
    ...
    privateScope.onOpen = function (openInfo) {
        ...
        if (openInfo) {
            ...
            if (privateScope.isMavlinkTunnelEnabled()) {
                ...
                MSP.setTransportTransform((buffer, code) => privateScope.mavlinkTunnel.wrapMspFrame(buffer, code));
